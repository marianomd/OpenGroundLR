...
//     screen_puts_xy(1, y, 1, "system5x7 1234 ABCD");
//     y = h + 10;

//     screen_set_font(font_tomthumb3x5, &h, 0);
//     screen_puts_xy(1, h + 10, 1, "tomthumb3x5 1234 ABCD");
//     y = h + 10;
    
//     screen_set_font(font_metric7x12, &h, 0);
//     screen_puts_xy(1, h + 10, 1, "metric7x12 1234 ABCD");
//     screen_update();
//  while (1)
//     {}
    pstr("Init done.\n");
